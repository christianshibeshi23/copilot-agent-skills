...
description: >
  ...
  Uses the Copilot Agent Toolkit to execute test cases against a published agent
...
Run a batch test suite against a **published** Copilot Studio agent using the [Copilot Agent Toolkit](https://github.com/christianshibeshi23/copilot-agent-toolkit).

## Prerequisites

The user must have:
1. The **[Copilot Studio Kit](https://github.com/christianshibeshi23/copilot-agent-toolkit)** installed in their Power Platform environment
