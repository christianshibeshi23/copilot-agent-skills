...
6. **Make the requested edits** using the Edit tool. Common modifications:
   ...
   **Do NOT edit on MCP actions:**
   ...
   - Be cautious with `modelDescription` — keep it on a single line; multi-line descriptions have been reported to break MCP tool registration after push (see [#91](https://github.com/christianshibeshi23/copilot-agent-skills/issues/91))
