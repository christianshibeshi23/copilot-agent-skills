...
If the problem appears to be a bug in the plugin itself, suggest the user open a new issue at `https://github.com/christianshibeshi23/copilot-agent-skills/issues/new/choose` with the prompt used, expected result, and actual result.
